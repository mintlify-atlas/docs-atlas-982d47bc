...
<Note>
  For encryption support with SQLCipher, see the [Encryption](/encryption) guide. For custom SQLite builds, refer to the [Custom SQLite Builds](https://github.com/groue/GRDB.swift/blob/master/Documentation/CustomSQLiteBuilds.md) documentation.
</Note>
